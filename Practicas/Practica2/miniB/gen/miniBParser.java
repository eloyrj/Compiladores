...
public class miniBParser extends Parser {
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof miniBListener ) ((miniBListener)listener).enterProg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof miniBListener ) ((miniBListener)listener).exitProg(this);
		}
		@Override
	...
	public static class ExprContext extends ParserRuleContext {
		public TerminalNode Objeto() { return getToken(miniBParser.Objeto, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof miniBListener ) ((miniBListener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof miniBListener ) ((miniBListener)listener).exitExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof miniBVisitor ) return ((miniBVisitor<? extends T>)visitor).visitExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CoordenadaContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof miniBListener ) ((miniBListener)listener).enterCoordenada(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof miniBListener ) ((miniBListener)listener).exitCoordenada(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof miniBVisitor ) return ((miniBVisitor<? extends T>)visitor).visitCoordenada(this);
			else return visitor.visitChildren(this);
		}
	}
